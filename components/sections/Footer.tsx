          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a
                ...
                className="w-12 h-12 bg-stone-800 rounded-full flex items-center justify-center hover:bg-amber-700 transition-all duration-300 transform hover:scale-110"
